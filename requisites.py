...
def records():
    ...
    cur.execute('''INSERT INTO sto(organisation, region, city, street, myindex, 
...
cur = conn.cursor()
cur.execute('''CREATE TABLE IF NOT EXISTS sto(id integer primary key, organisation TEXT, 
